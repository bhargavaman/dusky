...
# 2. Package Installation (Including TPM and OS Info databases)
log_info "Installing KVM packages via pacman..."
sudo pacman -S --needed --noconfirm \
    qemu-full virt-manager libvirt dnsmasq iptables-nft edk2-ovmf \
    virt-viewer swtpm bridge-utils openbsd-netcat libosinfo

# 3. Modular Daemon Configuration (Deprecating monolithic libvirtd)
...
sudo usermod -aG libvirt,kvm,input,disk "$USER"
