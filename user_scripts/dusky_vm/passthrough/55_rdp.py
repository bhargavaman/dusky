...
def print_rdp_troubleshooting(ip_addr: str):
    ...
    trouble_text += (
        ...
        "       c. In the [italic white]left-hand navigation tree[/italic white], click directly on [bold yellow]Network List Manager Policies[/bold yellow].\n"
        "       d. In the [italic white]right pane[/italic white], double-click [bold cyan]'Unidentified Networks'[/bold cyan].\n"
        "       e. Change [bold]Location type[/bold] from Not Configured to [bold green]Private[/bold green], and click OK.\n"
        "       f. (Temporary Fix): Run [bold cyan]Set-NetConnectionProfile -NetworkCategory Private[/bold cyan] in PowerShell (Admin).\n\n"
