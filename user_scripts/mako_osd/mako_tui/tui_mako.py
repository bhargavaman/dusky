...
SCHEMA = {
    ...
    4: [
        ...
        ConfigItem(label="Font", key="font", scope="app-name=dusky-glance", type_="string", default="monospace 10", parent_ref="menu_glance", extended_help="**Glance Font**\n\nTypography settings for the Glance metrics."),
        ...
        ConfigItem(label="Font", key="font", scope="app-name=dusky-glance-alert", type_="string", default="monospace 12", parent_ref="menu_glance_alert", extended_help="**Glance Alert Font**\n\nTypography settings for the critical hardware prompts."),
